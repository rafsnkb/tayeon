import { SpreadDualIcon } from "tayeon";
...
export const Tones = () => (
  <div className="flex items-center gap-6 rounded-2xl border border-border bg-surface px-6 py-5">
    <SpreadDualIcon className="text-bold-text" />
    <SpreadDualIcon className="text-icon-muted" />
    <SpreadDualIcon className="text-point" />
    <SpreadDualIcon className="text-urgent" />
  </div>
);
...
export const InContext = () => (
  <div className="flex w-[300px] items-center gap-3 rounded-2xl border border-border bg-surface px-5 py-4">
    ...
    <span className="text-sm font-semibold text-bold-text">양자택일</span>
  </div>
);
