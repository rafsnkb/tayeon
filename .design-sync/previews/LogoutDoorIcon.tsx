import { LogoutDoorIcon } from "tayeon";
...
export const Tones = () => (
  <div className="flex items-center gap-6 rounded-2xl border border-border bg-surface px-6 py-5">
    <LogoutDoorIcon className="text-bold-text" />
    <LogoutDoorIcon className="text-icon-muted" />
    <LogoutDoorIcon className="text-point" />
    <LogoutDoorIcon className="text-urgent" />
  </div>
);
...
export const InContext = () => (
  <div className="flex w-[300px] items-center gap-3 rounded-2xl border border-border bg-surface px-5 py-4">
    ...
    <span className="text-sm font-semibold text-bold-text">로그아웃</span>
  </div>
);
