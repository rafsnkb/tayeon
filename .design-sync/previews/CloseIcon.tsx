...
export const Tones = () => (
  <div className="flex items-center gap-6 rounded-2xl border border-border bg-surface px-6 py-5">
    <CloseIcon className="text-bold-text" />
    <CloseIcon className="text-icon-muted" />
    <CloseIcon className="text-point" />
    <CloseIcon className="text-urgent" />
  </div>
);
...
export const InContext = () => (
  <div className="flex w-[300px] items-center gap-3 rounded-2xl border border-border bg-surface px-5 py-4">
    ...
    <span className="text-sm font-semibold text-bold-text">닫기</span>
  </div>
);
