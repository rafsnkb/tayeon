...
export const MARRIAGE_TIMING: SajuProduct = {
  ...
  sections: [
    ...
    { id: "timing-window", title: "결혼운이 열리고 안정되는 시기" },
    { id: "meeting-context", title: "만남의 계기" },
    { id: "spouse-portrait", title: "배우자의 성격과 생활·경제관" },
    { id: "path-to-marriage", title: "연애에서 결혼으로 가는 과정" },
    { id: "married-life", title: "결혼 후 생활의 특징" },
    { id: "prep-guide", title: "준비를 위한 현실 가이드" },
  ],
