...
export const WELLNESS_RHYTHM: SajuProduct = {
  ...
  sections: [
    ...
    { id: "dip-pattern", title: "컨디션 저하 패턴" },
    { id: "areas-to-watch", title: "관리가 필요한 신체 영역" },
    { id: "overwork-flow", title: "과로하기 쉬운 흐름" },
    { id: "sleep-recovery", title: "수면·회복 패턴" },
    { id: "diet-activity-routine", title: "식사·활동 루틴 점검" },
    { id: "by-age-care", title: "연령대별 생활관리 포인트" },
    { id: "this-year-condition", title: "올해 컨디션 흐름" },
    { id: "healthy-living-guide", title: "건강한 생활 가이드" },
  ],
