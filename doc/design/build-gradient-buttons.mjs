...
const CANDIDATES = [
  ...
  },
  {
    ...
    to: "#d23c21",
    label: "#ffffff",
    note: "핑크에서 따뜻한 쪽으로 넘어간다. 호리의 보라와 정반대 방향. 코랄 끝은 원래 #e04a2f였는데 흰 글씨가 4.05로 미달이라, 색상각 32°는 그대로 두고 밝기만 0.62→0.58로 내렸다.",
  },
  {
    id: "magenta-coral-original",
    theme: "light",
    name: "자홍 → 코랄 · 원본 (참고: 미달)",
    from: "#c2005f",
    to: "#e04a2f",
    label: "#ffffff",
    note: "조정 전. 밝기 차이가 거의 안 보이는데 판정은 갈린다 — 비교용.",
  },
  {
    id: "wine-pink-light",
    theme: "light",
